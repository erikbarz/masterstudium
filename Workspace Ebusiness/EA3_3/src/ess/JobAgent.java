				...
				while (e.hasMoreElements()) {
					...
					if (msg.getPerformative() == ACLMessage.PROPOSE) {							
						...
						// wenn Kosten nicht im Budget liegen
							...
							System.out.println("Jobagent "+getLocalName()+": Kosten der aktuell geprüften Maschine liegen nicht im Budget:  Fertigstellung=" + proposeFertigstellung + ", Kosten=" + proposeKosten + ", " + msg.getSender().getLocalName());
							//Absage vorbereiten
							ACLMessage reply = msg.createReply();
							reply.setPerformative(ACLMessage.REJECT_PROPOSAL);
							acceptances.addElement(reply);
